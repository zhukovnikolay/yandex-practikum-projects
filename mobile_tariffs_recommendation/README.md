...
## Вывод
Лучшие результаты показали бустинг (accuracy на test: 0.793) и случайный лес (accuracy на test: 0.786).

Все разработанные модели показали свою адекватность, превзойдя результат baseline-модели. 

## Используемые библиотеки
*itertools, pandas, sklearn, catboost, seaborn*